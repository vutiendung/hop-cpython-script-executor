...
public class CPythonScriptExecutorMeta extends BaseTransformMeta<CPythonScriptExecutor, CPythonScriptExecutorData> {
  ...
  protected static final String LIBRARY_TAG = "py_library";
  ...
  protected String m_pythonLibrary = "pandas";
  ...
  public String getXml() {
    ...
    buff.append(XmlHandler.addTagValue(LIBRARY_TAG, getLibrary()));
  ...
  public void loadXml(Node transformNode, IHopMetadataProvider metadataProvider)
    ...
    setLibrary(XmlHandler.getTagValue(transformNode, LIBRARY_TAG));
